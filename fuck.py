...
for xd in range(10000):
	a=ua_ios = 'Mozilla/5.0 (iPhone, CPU iPhone '+version+' like Mac OS '+os+') AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/'+ipsw+' [FBAN/MessengerForiOS;FBAV/'+fbav+';FBBV/'+fbbv+';FBDV/'+fbdv+';FBMD/iPhone;FBSN/iOS;FBSV/'+fbsv+';FBSS/2;FBCR/Mobifone;FBID/phone;FBLC/en_GB;FBOP/5;FBRV/0]'
